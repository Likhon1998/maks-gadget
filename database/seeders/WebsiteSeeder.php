...
class WebsiteSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $navLinks = [
            ...
            ['label' => 'Phones', 'url' => '/shop?search=phone', 'location' => 'main_nav', 'sort_order' => 3],
            ['label' => 'Laptops', 'url' => '/shop?search=laptop', 'location' => 'main_nav', 'sort_order' => 4],
            ['label' => 'Deals', 'url' => '/shop?filter=deals', 'location' => 'main_nav', 'sort_order' => 5],
            ['label' => 'New', 'url' => '/shop?filter=new', 'location' => 'main_nav', 'sort_order' => 6],
